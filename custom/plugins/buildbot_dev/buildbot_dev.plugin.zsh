...
alias cj9='cactus jump buildbot-nine'
alias cjx='cactus jump xutils'
alias cj6='cactus jump oc6'
...
alias crwcsrcib='cactus restart --wait ; cactus slaves restart ; cactus info ; bing'
alias ckcrwcsrcib='cactus kill ; cactus restart --wait ; cactus slaves restart ; cactus info ; bing'
alias CR='ckcrwcsrcib'
