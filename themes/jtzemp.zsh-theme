...
DALLAS_CURRENT_TIME_="%{$fg[blue]%}[%{$fg[red]%}%T%{$fg[blue]%}]%{$reset_color%}"
...
# Put it all together!
PROMPT="$DALLAS_CURRENT_TIME_ $DALLAS_CURRENT_USER_$DALLAS_CURRENT_MACH_$DALLAS_CURRENT_LOCA_ $DALLAS_PROMPT_CHAR_ "
