PROMPT='%{$FG[239]%}┌[%{$FG[040]%}%n%{$reset_color%}%{$FG[196]%}@%{$FG[208]%}%M%{$reset_color%}%{$FG[239]%}]%{$fg[white]%}-%{$FG[220]%}(%{$fg_bold[white]%}%~%{$reset_color%}%{$FG[220]%})%{$fg[white]%}-$(git_prompt_info)%{$FG[033]%}%D{[%H:%M:%S]} %(?..%{$FG[196]%}✘(%?%)%{$reset_color%})
%{$FG[239]%}└>%{$reset_color%}'
