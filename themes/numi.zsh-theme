...
PROMPT='
[$(date +%H:%M)] $(_user_host)${_current_dir} $(git_prompt_info) $(_ruby_version)
▶ '
...
local _hist_no="%{$fg_bold[grey]%}%h%{$reset_color%}"
...
function _ruby_version() {
  if {echo $fpath | grep -q "plugins/rvm"}; then
    echo "%{$fg_bold[grey]%}$(rvm_prompt_info)%{$reset_color%}"
  fi
}
...
export LS_COLORS='di=1;34:ln=1;35:so=32:pi=33:ex=31:bd=1;34;46:cd=1;34;43:su=0;41:sg=0;46:tw=0;42:ow=0;43:'
