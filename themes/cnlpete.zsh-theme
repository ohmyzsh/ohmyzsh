...
#   * One line.
#   * short VCS info on the right prompt.
...
# check-for-changes can be slow on big repos.
zstyle ':vcs_info:(hg*|git*|bzr*):*' check-for-changes true
zstyle ':vcs_info:*:*' unstagedstr '*'
zstyle ':vcs_info:*:*' stagedstr '+'
zstyle ':vcs_info:*:*' actionformats "%r:%S (%a)" "%b %{$fg_bold[red]%}%u%c"
zstyle ':vcs_info:*:*' formats "%r:%S" "%b %{$fg_bold[red]%}%u%c"
