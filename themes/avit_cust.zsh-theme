...
RPROMPT='$(vi_mode_prompt_info)%{$(echotc UP 1)%}$(_git_time_since_commit) $(git_prompt_status)    %{$fg_bold[red]%}[${CURRENT_TIME_}] ${_return_status}%{$(echotc DO 1)%} '
