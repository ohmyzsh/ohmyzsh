...
To learn more, visit [ohmyz.sh](https://ohmyz.sh), follow [@ohmyzsh](https://twitter.com/ohmyzsh) on X(formerly Twitter), and join us on [Discord](https://discord.gg/ohmyzsh).
...
- [@ohmyzsh](https://twitter.com/ohmyzsh) on X(formerly Twitter). You should follow it.
