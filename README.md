...
```shell
sh -c "$(wget -O- https://raw.githubusercontent.com/bluekrow/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
curl -Lo install.sh https://raw.githubusercontent.com/bluekrow/oh-my-zsh/master/tools/install.sh
sh install.sh
```
...
We'll admit it. Early in the Oh My Zsh world, we may have gotten a bit too theme happy. We have over one hundred themes now bundled. Most of them have [screenshots](https://github.com/bluekrow/oh-my-zsh/wiki/Themes) on the wiki. Check them out!
