...
| aguc    | `sudo $APT update && sudo $APT list --upgradable                         | Update packages list and show the upgradable packages                                             |
...
| agulc   | `sudo $APT update && list --upgradable && upgrade -y && autoclean        | Updates packages list, displays upgradable packages, upgrades the packages, and autocleans        |
