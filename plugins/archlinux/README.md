...
| yayinsd  | yay -S --asdeps                    | Install packages as dependencies of another package                 |
| yayloc   | yay -Qi                            | Display information about a package in the local database           |
| yaylocs  | yay -Qs                            | Search for packages in the local database                           |
| yaylst   | yay -Qe                            | List installed packages including from AUR (tagged as "local")      |
| yaymir   | yay -Syy                           | Force refresh of all package lists after updating mirrorlist        |
| yayorph  | yay -Qtd                           | Remove orphans using yaourt                                         |
| yayre    | yay -R                             | Remove packages, keeping its settings and dependencies              |
| yayrem   | yay -Rns                           | Remove packages, including its settings and unneeded dependencies   |
| yayrep   | yay -Si                            | Display information about a package in the repositories             |
| yayreps  | yay -Ss                            | Search for packages in the repositories                             |
| yayupg   | yay -Syu                           | Sync with repositories before upgrading packages                    |
| yaysu    | yay -Syu --no-confirm              | Same as `yaupg`, but without confirmation                           |
