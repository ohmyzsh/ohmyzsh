...
alias zps='zypper ps' #list process using deleted files
...
alias zlp='zypper lp' #list necessary patchs
...
alias zpattern-info='zypper patch-info' #display info about patterns
alias zproduct-info='zypper patch-info' #display info about products
