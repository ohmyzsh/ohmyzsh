...
# Run mvnd against the pom found in a project's root directory (assumes a git repo)
alias 'mvnd!'='mvnd -f $(git rev-parse --show-toplevel 2>/dev/null || echo ".")/pom.xml'

# aliases
alias mvndag='mvnd archetype:generate'
alias mvndboot='mvnd spring-boot:run'
alias mvndc='mvnd clean'
alias mvndcd='mvnd clean deploy'
alias mvndce='mvnd clean eclipse:clean eclipse:eclipse'
alias mvndci='mvnd clean install'
alias mvndcie='mvnd clean install eclipse:eclipse'
alias mvndcini='mvnd clean initialize'
alias mvndcist='mvnd clean install -DskipTests'
alias mvndcisto='mvnd clean install -DskipTests --offline'
alias mvndcom='mvnd compile'
alias mvndcp='mvnd clean package'
alias mvndct='mvnd clean test'
alias mvndcv='mvnd clean verify'
alias mvndcvst='mvnd clean verify -DskipTests'
alias mvnddocs='mvnd dependency:resolve -Dclassifier=javadoc'
alias mvnddt='mvnd dependency:tree'
alias mvnde='mvnd eclipse:eclipse'
alias mvndfmt='mvnd fmt:format'
alias mvndjetty='mvnd jetty:run'
alias mvndp='mvnd package'
alias mvndqdev='mvnd quarkus:dev'
alias mvnds='mvnd site'
alias mvndsrc='mvnd dependency:sources'
alias mvndt='mvnd test'
alias mvndtc='mvnd tomcat:run'
alias mvndtc7='mvnd tomcat7:run'
alias mvnd-updates='mvnd versions:display-dependency-updates'


function listMvndCompletions {
  local file new_file
...
compctl -K listMvndCompletions mvnd
compctl -K listMvndCompletions mvnd-color
