...
| gba                  | git branch -a                                                                                                                    |
| gbd                  | git branch -d                                                                                                                    |
| gbda                 | git branch --no-color --merged \| command grep -vE "^(\+\|\*\|\s*(main\|development\|develop\|devel\|dev)\s*$)" \| command xargs -n 1 git branch -d |
| gbD                  | git branch -D                                                                                                                    |
| gbl                  | git blame -b -w                                                                                                                  |
...
| git-svn-dcommit-push | git svn dcommit && git push github main:svntrunk                                                                                 |
