...
|         |                                     | **Kustomization**                                                                                |
| kak     | `kubectl apply -k`                  | Apply resources from a directory containing kustomization.yaml                                   |
| kdk     | `kubectl delete -k`                 | Delete resources from a directory containing kustomization.yaml                                  |
| kk      | `kubectl kustomize`                 | Print a set of API resources generated from instructions in a kustomization.yaml file            |
|         |                                     | **Get documentation of resources**                                                               |
| ke      | `kubectl explain`                   | List the fields for supported resources                                                          |
