...
# Nwidart Modules
alias pmake='php artisan module:make'
alias plist='php artisan module:list'
alias pmigrate='php artisan module:migrate'
alias prollback='php artisan module:migrate-rollback'
alias prefresh='php artisan module:migrate-refresh'
alias preset='php artisan module:migrate-reset'
alias pseed='php artisan module:seed'
alias penable='php artisan module:enable'
alias pdisable='php artisan module:disable'
