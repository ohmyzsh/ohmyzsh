...
alias la4migrate='php artisan migrate'
alias la4migratemake='php artisan migrate:make'
alias la4seed='php artisan db:seed'

alias la4down='php artisan down'
alias la4up='php artisan up'
alias la4tinker='php artisan tinker'
alias la4serve='php artisan serve'
